        ...
        <div className="h-full flex justify-center items-center align-center">
          <div className=" flex w-96 h-full justify-between items-center">
            <div className="flex w-28 justify-between items-center">
              <TbPlayerSkipBack className="text-neutral-200 h-6 w-6 mr-3" />
              {!activeTrack?.isPlaying ? (
                <IoPlay
                  onClick={handlePlayClick}
                  className="text-neutral-200 h-6 w-6 mr-3"
                />
              ) : (
                <IoStop
                  onClick={handlePlayClick}
              ...
              <TbPlayerSkipForward className="text-neutral-200 h-6 w-6 mr-3" />
            </div>
            <div className="flex w-14 justify-between items-center">
              {isMuted ? (
                <FiVolumeX
                  onClick={handleMuteClick}
                  className="text-neutral-200 h-6 w-7 ml-3"
                />
              ) : (
                <FiVolume2
                  onClick={handleMuteClick}
