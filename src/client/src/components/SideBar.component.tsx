...
export default function SideBar() {
  ...
  return (
    <div className='place-self-end self-center flex flex-col w-32 h-[60%] bg-neutral-800 shadow-sm shadow-black justify-between items-center py-[35px] rounded-xl'>
      ...
      <SideBarButton icon={<BsFillPersonFill style={{'filter' : 'drop-shadow(1px 1px 2px black)'}} className="text-4xl" />} text={'Stars'} />
